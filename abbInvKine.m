...
% 
% 
% [th1, th2, d3, th4, th5, th6,reachable] = abbInvKine(T_des,th_Last)
% Returns the joint angles required to reach the ABB arm.
%  
% Outputs
% th1 – th6  - the 6 joint angles. These are real scalar
% values if th_last is provided and are 8x1 vectors
% if th_last is not provided.
% reachable – is true if the transform can be
% achieved. Is false if it cannot be achieved.
% 
% 
% 
% Inputs
...
% th_last is a 6x1 vector of the last set of thetas used
% to select a specific solution. If th_last is not
% provided (check with exist(‘th_last’,’var’) ), then
% provide all 8 possibilities, otherwise return the
% closest solution to th_last. These should all be
% real values!
%
% 
% 
...
T03 = zeros(4,4,8);
for i = 1:8
    T03(:,:,i) = dhTransform1(a(1:3),d(1:3),alpha(1:3),theta(i,1:3),0,3);
end
